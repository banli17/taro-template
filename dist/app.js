...
function _slicedToArray(arr, i) {
  return (0, _arrayWithHoles2.default)(arr) || (0, _iterableToArrayLimit2.default)(arr, i) || (0, _nonIterableRest2.default)();
}
...
function _toConsumableArray(arr) {
  return (0, _arrayWithoutHoles2.default)(arr) || (0, _iterableToArray2.default)(arr) || (0, _nonIterableSpread2.default)();
}
...
var _dva = __webpack_require__(/*! ./dva */ "./src/dva.js");
...
var _App = function (_BaseComponent) {
  ...
  function _App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _App.__proto__ || Object.getPrototypeOf(_App)).call.apply(_ref, [this].concat(args))), _this), _this.config = {
      pages: ["pages/index/index", "pages/personal/index/index"],
      window: {
...
function createStore(_ref) {
  ...
  var composeEnhancers =  true && _window2.default.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? _window2.default.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({
    trace: true,
    maxAge: 30
  }) : _redux.compose;
...
exports.getDreamCategory = getDreamCategory;
exports.getDreamDetail = getDreamDetail;
exports.yunshi = yunshi;
...
function getDreamCategory(data) {
  return (0, _index.http_get)(API.dreamCategory, data);
}
function getDreamDetail(data) {
  return (0, _index.http_get)(API.dreamDetail, data);
}
function yunshi(data) {
  return (0, _index.http_get)(API.yunshi, data);
}
exports.default = {};
...
exports.API_HOME = undefined;

var _home = __webpack_require__(/*! ./home */ "./src/api/home.ts");

var API_HOME = _interopRequireWildcard(_home);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

exports.API_HOME = API_HOME;
exports.default = {};
...
function createApp(options) {
  ...
  app = (0, _dvaCore.create)(_extends({}, options));
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../node_modules/@tarojs/mini-runner/node_modules/webpack/buildin/global.js */ "./node_modules/@tarojs/mini-runner/node_modules/webpack/buildin/global.js")))
...
exports.default = {
  ...
  reducers: {
    ...
    modalShow: function modalShow(state, _ref2) {
      var payload = _ref2.payload;

      return _extends({}, state, { modal: _extends({}, payload, { show: true }) });
    },
    modalHide: function modalHide(state) {
      return _extends({}, state, { modal: _extends({}, state.modal, { show: false }) });
    }
  },
...
exports.default = {
  ...
  effects: {
    getYunshiSaga: /*#__PURE__*/_regenerator2.default.mark(function getYunshiSaga(action, _ref2) {
      var call = _ref2.call,
          put = _ref2.put,
          select = _ref2.select;
      var query, res;
      return _regenerator2.default.wrap(function getYunshiSaga$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return select(function (state) {
                return state.home.yunshi_query;
              });

            case 2:
              query = _context.sent;
              _context.next = 5;
              return call(_index.API_HOME.yunshi, query);
    ...
    updateConstellSaga: /*#__PURE__*/_regenerator2.default.mark(function updateConstellSaga(action, _ref3) {
      var call = _ref3.call,
          put = _ref3.put,
          select = _ref3.select;
      return _regenerator2.default.wrap(function updateConstellSaga$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
...
var _common = __webpack_require__(/*! ./common */ "./src/models/common.js");

var _common2 = _interopRequireDefault(_common);

var _home = __webpack_require__(/*! ./home */ "./src/models/home.js");

var _home2 = _interopRequireDefault(_home);

var _loginConfirm = __webpack_require__(/*! ./loginConfirm */ "./src/models/loginConfirm.js");

var _loginConfirm2 = _interopRequireDefault(_loginConfirm);

var _components = __webpack_require__(/*! ./components */ "./src/models/components.js");

var _components2 = _interopRequireDefault(_components);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = [_common2.default, _home2.default, _loginConfirm2.default, _components2.default];

/***/ }),

/***/ "./src/models/loginConfirm.js":
/*!************************************!*\
  !*** ./src/models/loginConfirm.js ***!
  \************************************/
/*! no static exports found */
...
exports.default = {
  ...
  reducers: {
    show: function show(state) {
      return _extends({}, state, { show: true });
    },
