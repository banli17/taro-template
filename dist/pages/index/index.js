...
var Card = (_dec = (0, _redux.connect)(function (state) {
  return {
...
var Index = (_temp2 = _class2 = function (_BaseComponent) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["resImg", "onImgOk", "template"], _this.state = {
      resImg: '',
      onImgOk: '',
      template: {
        width: '600rpx',
    ...
    }, _this.goDetail = function (item) {
      if (item.url) {
        _taroWeapp2.default.navigateTo({
          url: item.url
        });
      }
    }, _this.toggleConstell = function () {
      _taroWeapp2.default.navigateTo({
    ...
    }, _this.onImgOk = function (e) {}, _this.customComponents = ["Container"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Index, [{
    ...
    value: function saveImage() {
      var self = this;
      var ctx = _taroWeapp2.default.createCanvasContext('myCanvas');
      console.log(ctx);
      var img1 = __webpack_require__(/*! ../../assets/imgs/avatar.png */ "./src/assets/imgs/avatar.png");
      var img2 = __webpack_require__(/*! ../../assets/imgs/tab/home.png */ "./src/assets/imgs/tab/home.png");
  ...
  return Index;
}(_taroWeapp.Component), _class2.$$events = ["save"], _class2.$$componentPath = "pages/index/index", _temp2);
